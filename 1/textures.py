...
officeLightLeftBonny = pygame.image.load(officeFolder + '4.png')
officeLightRightChica = pygame.image.load(officeFolder + '5.png')
officeWithoutEnergy = pygame.image.load(officeFolder + '6.png')
officeWithoutEnergyWithFreddy = pygame.image.load(officeFolder + '7.png')
...
employeesOnlyText = pygame.image.load(EmployeesOnlyFolder + '5.png')
...
# end
end = pygame.image.load(texturesFolder + 'end.png')

five = pygame.image.load(endAM + '5.png')
six = pygame.image.load(endAM + '6.png')
Background = pygame.image.load(endAM + 'Background.png')